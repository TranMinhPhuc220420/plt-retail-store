...
# Production Storage and Route Fix Deployment Script
# Fixes 404 errors for avatar images in production
...
docker rmi plt-retail-store-backend:latest 2>/dev/null || true
...
docker volume ls | grep plt_storage || echo "Creating new storage volume..."
